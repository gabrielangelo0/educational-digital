          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-gray-800/50 border-gray-700 hover:border-blue-500/50 transition-all duration-300 group">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-gray-400">Python, Machine Learning e Análise de Dados</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center gap-4 mb-4 text-sm text-gray-400">
                  <div className="flex items-center gap-1">
            ...
            <Card className="bg-gray-800/50 border-gray-700 hover:border-green-500/50 transition-all duration-300 group">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-gray-400">Figma, Design System e Prototipação</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center gap-4 mb-4 text-sm text-gray-400">
                  <div className="flex items-center gap-1">
      ...
      <section id="depoimentos" className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Histórias reais de transformação profissional</p>
          </div>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">Transformando carreiras através da educação digital de qualidade.</p>
            </div>
            <div>
